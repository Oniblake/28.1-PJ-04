...
class AuthPage(BasePage):
    # TC1 метод проверки перехода на форму авторизации
    ...
    # TC2 метод проверки расположения логотипа и слогана
    ...
    # TC3 метод проверки расположения меню выбора типа аутентификации
    def location_of_the_tab_menu(self):
        assert self.is_element_present(AuthPageLocators.AUTH_TAB_MENU), "element not found"

    # TC4 метод проверки типа аутентификации по умолчанию
    ...
    # TC5 метод проверки автоматического изменения типа аутентификации
    ...
    # TC6 метод проверки ссылки на форму восстановления пароля
    ...
    # TC7 метод проверки ссылки на форму регистрации
    ...
    # TC8 метод проверки ссылки под кнопкой "Войти" на страницу с пользовательским соглашением
    ...
    # TC9 метод проверки ссылки в футере на страницу с пользовательским соглашением
    ...
    # TC10 метод проверки ссылки на страницу авторизации с помощью соцсети "ВКонтакте"
    ...
    # TC11 метод проверки авторизации с незаполненными полями
    ...
    # TC12 метод проверки текстового поля на SQL-инъекции
