...
class ChangePassPage(BasePage):
    # TC13 метод проверки типа восстановления пароля по умолчанию
    ...
    # TC14 метод проверки на валидацию поля ввода номера телефона /почты /логина /лицевого счета (ввод валидного номера)
    ...
    # TC15 метод проверки на валидацию поля ввода номера телефона /почты /логина /лицевого счета (ввод валидного email)
    ...
    # TC16 метод проверки кнопки на форму авторизации
    ...
    # TC17 метод проверки ссылки в футере на страницу с пользовательским соглашением
    ...
    # TC18 метод проверки восстановления пароля с незаполненными полями
    ...
    # TC19 метод проверки восстановления пароля с незаполненным значением капчи
    ...
    # TC20 метод проверки текстового поля на SQL-инъекции
